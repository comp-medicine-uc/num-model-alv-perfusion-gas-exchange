...
avg_speed_size = 1  # (Normal is 1000)
...
params = {
    "kappa": kappa,
    "mu": mu,
    "p_max": Constant(p_max),
    "p_min": Constant(p_min),
    "d_pla_O2": d_pla_O2,
    "d_ba_O2": d_ba_O2,
    "d_pla_CO2": d_pla_CO2,
    "d_ba_CO2": d_ba_CO2,
    ...
    "h_ba": h_ba,
    "p_air_O2": Constant(p_air_O2),
    "p_air_CO2": Constant(p_air_CO2),
    "p_O2_in": Constant(p_O2_in),
    "p_CO2_in": Constant(p_CO2_in),
    "c_t": c_t
}